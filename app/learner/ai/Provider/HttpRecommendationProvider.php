    ...
    private function performGenerate(ProviderRequest $request, ProviderAttemptAuthorizer $authorizer): ProviderResponse
    {
        ...
        for ($attempt = 1; $attempt <= $this->config->maxAttempts(); $attempt++) {
            ...
            try {
                ...
                $this->logGeminiInteraction('Tạo bản phân tích (AI Recommendation)', $body, 'CURL/Network Error: ' . $e->getMessage(), 0);
            ...
            $this->logGeminiInteraction('Tạo bản phân tích (AI Recommendation)', $body, $response['body'] ?? '', $status);
