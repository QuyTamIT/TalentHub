...
try {
    ...
    $unknownQueryFields = array_keys($request->queryParams());
    ...
    $data = $factory->badgeReadService()->forStudent($studentId);
    ...
    JsonResponder::sendError(
        new ApiException(500, 'INTERNAL_ERROR', 'Đã xảy ra lỗi hệ thống khi tải huy hiệu.'),
