...
final class GitScopeGuard
{
    ...
    private const ALLOWED_EXACT_PATHS = [
        ...
        'bin/run-demo-ai.php',
        'bin/plan-learner-ai-shadow-sample.php',
        'bin/run-learner-ai-shadow-evaluation.php',
        'bin/report-learner-ai-evaluation.php',
        ...
        'src/Modules/School/Repository/SchoolAiAggregateRepository.php',
        'src/Modules/Employer/CandidateService.php',
        ...
        'app/enterprise/talents/detail.php',
        'app/school/students.php',
        'bin/audit-score-provenance.php',
        ...
        'tests/teacher_grading_school_skills_test.php',
        'tests/enterprise_official_score_query_test.php',
        'tests/score-transparency.spec.ts',
    ];
