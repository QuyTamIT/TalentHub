...
<section class="teacher-section-box">
    <div class="teacher-section-box__header">
        <div>
            ...
            <p class="teacher-section-box__subtitle">Các tác vụ cần Thầy/Cô thực hiện và theo dõi.</p>
        </div>
    ...
    <?php if (empty($pendingActions)): ?>
        <div class="teacher-empty-state">
            ...
            <h4 class="teacher-empty-state__title">Không có việc cần xử lý</h4>
            <p class="teacher-empty-state__desc">Hiện tại tất cả bài đánh giá, hoạt động và đăng ký đều ở trạng thái hoàn thành.</p>
        </div>
    <?php else: ?>
