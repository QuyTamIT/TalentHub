    ...
    <div class="school-welcome__body">
        <div class="school-welcome__content">
            ...
            <div class="school-welcome__actions">
                <a href="./analytics.php" class="btn btn-primary" data-testid="school-analytics-link">
                ...
                <a href="./reports.php" class="btn btn-secondary" data-testid="school-reports-link">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                ...
                <a href="./settings.php" class="btn btn-outline" data-testid="school-settings-link">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
