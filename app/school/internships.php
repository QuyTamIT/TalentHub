...
<div id="school-toast-msg"></div>

<div class="school-section-box" style="margin-bottom:1.5rem; padding: 1.25rem 1.5rem;">
    <div class="school-flex-between" style="flex-wrap: wrap; gap: 1rem;">
        <div>
        ...
        <div style="display:flex; gap:0.75rem; flex-wrap:wrap">
            <?php foreach ($oversight['summary'] as $status => $count): ?>
                <div class="school-card-subtle school-flex-center" style="padding: 0.4rem 0.85rem;">
                    <span class="school-text-sm-muted"><?= htmlspecialchars($labels[$status] ?? $status); ?>:</span>
...
<div class="school-section-box">
    <div class="school-flex-between" style="flex-wrap: wrap; gap: 1rem; margin-bottom: 1.25rem;">
        <div>
            <h3 style="font-size: 1.05rem; font-weight: 700; color: #0F172A; margin: 0;">Danh sách sinh viên & Phân công Mentor</h3>
            <span class="school-text-sm-muted">Tổng số: <?= count($oversight['items']); ?> đơn</span>
        </div>
        <a href="javascript:void(0)" onclick="openGuideModal()" style="display: inline-flex; align-items: center; min-height: 44px; gap: 0.4rem; padding: 0.4rem 0.85rem; border-radius: 8px; font-size: 0.875rem; font-weight: 600; color: #0369A1; background: #E0F2FE; border: 1px solid #BAE6FD; text-decoration: none; cursor: pointer; transition: background 0.2s;">
    ...
    <?php if ($oversight['items'] === []): ?>
        <div class="school-empty-state">
            ...
            <p class="school-empty-state__desc">Chưa có đơn thực tập nào thuộc trường.</p>
        </div>
    <?php else: ?>
            ...
            <table class="school-class-table">
                <thead>
                    <tr>
                        ...
                        <th>Doanh nghiệp</th>
                        <th>Trạng thái</th>
                        <th style="min-width: 240px;">Giáo viên hướng dẫn (Mentor)</th>
                ...
                <tbody>
                    <?php foreach ($oversight['items'] as $item): ?>
                        <tr>
                            ...
                            <td style="color: #334155; font-size: 0.9rem; font-weight: 600;">
                                <?= htmlspecialchars((string) $item['enterpriseName']); ?>
                            </td>
                            <td>
                                <?php
                                    $st = (string) $item['status'];
                                    $badgeClass = $badgeClasses[$st] ?? 'school-badge--info';
                                ?>
                                <span class="school-badge <?= $badgeClass ?>">
                                    ● <?= htmlspecialchars($labels[$st] ?? $st); ?>
                                </span>
                            </td>
                            <td>
                                <?php if (in_array($item['status'], ['interview', 'accepted'], true)): ?>
                                    <form method="post" class="mentor-assign-form school-flex-center" style="margin: 0;">
...
<div class="school-guide-modal-overlay" id="guideModalOverlay" onclick="if(event.target === this) closeGuideModal()" style="padding: 1rem;">
    <div class="school-guide-modal-box">
        <div class="school-guide-modal-header">
            <div class="school-flex-center" style="gap: 0.75rem;">
        ...
        <div style="padding: 1.5rem;">
            <div class="school-guide-modal-step">
                <div class="school-guide-modal-number">1</div>
                <div>
            ...
            <div class="school-guide-modal-step">
                <div class="school-guide-modal-number">2</div>
                <div>
            ...
            <div class="school-guide-modal-step">
                <div class="school-guide-modal-number">3</div>
                <div>
...
<div class="school-guide-modal-overlay" id="detailModalOverlay" onclick="if(event.target === this) closeInternshipDetail()" style="display: none; padding: 2rem 1rem;">
    <div class="school-guide-modal-box" style="max-width: 800px; max-height: 90vh; display: flex; flex-direction: column;">
        <div class="school-guide-modal-header" style="background: linear-gradient(135deg, #0F172A 0%, #1E293B 100%); flex-shrink: 0;">
            <div class="school-flex-center" style="gap: 0.75rem;">
                <div style="background: rgba(255,255,255,0.2); border-radius: 8px; padding: 0.5rem; display: flex;">
        ...
        <div style="padding: 1.5rem; overflow-y: auto; flex-grow: 1;">
            <div style="display: grid; grid-template-columns: 2fr 1.2fr; gap: 1.5rem;">
                ...
                <div style="display: flex; flex-direction: column; gap: 1.25rem;">
                    ...
                    <div class="school-card-subtle" style="padding: 1.25rem;">
                    ...
                    <div class="school-card-subtle" style="padding: 1.25rem;">
                        ...
                        <div style="display: grid; gap: 1rem;">
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                                <div>
                                    <div class="school-text-xs-upper" style="margin-bottom: 0.2rem;">Vị trí ứng tuyển</div>
                                    <div style="font-size: 0.95rem; color: #0284C7; font-weight: 600;" id="detailPostTitle">...</div>
                                </div>
                                <div>
                                    <div class="school-text-xs-upper" style="margin-bottom: 0.2rem;">Doanh nghiệp</div>
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; border-top: 1px dashed #E2E8F0; padding-top: 1rem;">
                                <div>
                                    <div class="school-text-xs-upper" style="margin-bottom: 0.2rem;">Ngày nộp đơn</div>
                                    <div style="font-size: 0.95rem; color: #1E293B; font-weight: 600;" id="detailAppliedDate">...</div>
                                </div>
                                <div>
                                    <div class="school-text-xs-upper" style="margin-bottom: 0.2rem;">Mức phụ cấp (dự kiến)</div>
                ...
                <div style="display: flex; flex-direction: column; gap: 1.25rem;">
                    ...
                    <div class="school-card-subtle" style="padding: 1.25rem;">
                        <div class="school-text-xs-upper" style="margin-bottom: 0.4rem;">Trạng thái hiện tại</div>
                        <div style="font-size: 1.1rem; color: #C2410C; font-weight: 800; margin-bottom: 1rem;" id="detailStatus">...</div>
                        
                        <div class="school-text-xs-upper" style="margin-bottom: 0.4rem;">Mentor (GVHD)</div>
                    ...
                    <div class="school-card-subtle" style="padding: 1.25rem; flex-grow: 1;">
                        ...
                        <div class="school-timeline">
                            <div class="school-timeline__item">
                                <div class="school-timeline__dot active"></div>
                                <div class="school-timeline__date" id="timelineAppliedDate">01/08/2026</div>
                                <div class="school-timeline__content">Đã nộp đơn ứng tuyển</div>
                            </div>
                            <div class="school-timeline__item">
                                <div class="school-timeline__dot active"></div>
                                <div class="school-timeline__date">05/08/2026</div>
                                <div class="school-timeline__content">Doanh nghiệp phỏng vấn</div>
                            </div>
                            <div class="school-timeline__item">
                                <div class="school-timeline__dot current"></div>
                                <div class="school-timeline__date">10/08/2026</div>
                                <div class="school-timeline__content">Đã nhận vào thực tập</div>
                            </div>
                            <div class="school-timeline__item" style="opacity: 0.5;">
                                <div class="school-timeline__dot"></div>
                                <div class="school-timeline__date">Sắp tới</div>
                                <div class="school-timeline__content">Đánh giá giữa kỳ</div>
                            </div>
                        </div>
                    </div>
...
<div class="school-guide-modal-overlay" id="updateModalOverlay" onclick="if(event.target === this) closeInternshipUpdate()" style="display: none;">
    <div class="school-guide-modal-box">
        <div class="school-guide-modal-header" style="background: linear-gradient(135deg, #EA580C 0%, #C2410C 100%);">
            <div class="school-flex-center" style="gap: 0.75rem;">
                <div style="background: rgba(255,255,255,0.2); border-radius: 8px; padding: 0.5rem; display: flex;">
