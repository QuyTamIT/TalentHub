...
<?php if ($flash): ?>
    <div class="school-flash school-flash--success" style="display: flex; align-items: center; gap: 0.5rem; padding: 1rem 1.25rem; border-radius: 8px; margin-bottom: 1.5rem;">
...
<?php endif; ?>
<?php if ($error): ?>
    <div class="school-flash school-flash--error" style="display: flex; align-items: center; gap: 0.5rem; padding: 1rem 1.25rem; border-radius: 8px; margin-bottom: 1.5rem;">
...
<div class="school-grid-2col school-grid-2col--reports" style="gap: 1.75rem; align-items: start;">
    ...
    <div class="school-section-box" style="margin-bottom: 0;">
        ...
        <form method="post" class="school-form" novalidate>
            ...
            <div class="school-form__grid">
                ...
                <div class="school-grid-2col" style="gap: 0.85rem;">
                    <label class="school-form__field">
                        <span>Từ ngày</span>
                        <input type="date" name="periodStart" value="<?= date('Y-m-01'); ?>" class="school-input-date">
                    </label>
                    <label class="school-form__field">
                        <span>Đến ngày</span>
                        <input type="date" name="periodEnd" value="<?= date('Y-m-d'); ?>" class="school-input-date">
                    </label>
                </div>
            </div>
    ...
    <div class="school-section-box" style="margin-bottom: 0; display: flex; flex-direction: column;">
        ...
        <?php if ($reports === []): ?>
            <div class="school-empty-state">
                <svg class="school-empty-state__icon" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" stroke-width="1.5">
                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                    <polyline points="14 2 14 8 20 8"></polyline>
                </svg>
                <p class="school-empty-state__desc">Chưa có báo cáo nào được tạo. Hãy chọn loại báo cáo và nhấn <strong>Tạo báo cáo</strong>.</p>
            </div>
        <?php else: ?>
