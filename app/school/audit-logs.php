...
$extraStyles = <<<'HTML'
<style>
.school-audit-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1rem;margin-bottom:1.25rem}.school-audit-kpi{background:#fff;border:1px solid #F0E6DD;border-radius:12px;padding:1rem 1.15rem;box-shadow:0 4px 20px rgba(50,32,20,0.04)}.school-audit-kpi span{display:block;color:#6B5548;font-size:.84rem;margin-bottom:.4rem}.school-audit-kpi strong{color:#322014;font-size:1.65rem}.school-audit-filter{display:grid;grid-template-columns:2fr 1.2fr 1fr 1fr;gap:1rem;align-items:end}.school-audit-filter label span{display:block;font-size:.82rem;font-weight:700;color:#6B5548;margin-bottom:.4rem}.school-audit-filter input,.school-audit-filter select{width:100%;min-height:42px;border:1px solid #F0E6DD;border-radius:8px;padding:.55rem .7rem;background:#fff;color:#322014}.school-audit-filter input:focus,.school-audit-filter select:focus{border-color:#F83F70;outline:none;box-shadow:0 0 0 3px rgba(248,63,112,0.18)}.school-audit-filter__actions{display:flex;gap:.6rem;grid-column:1/-1}.school-audit-table-box{margin-top:1.25rem}.school-audit-table-wrap{overflow:auto}.school-audit-table-wrap table{min-width:980px}.school-audit-muted{color:#9E897D;font-size:.86rem;margin:0}.school-audit-type{display:inline-flex;border-radius:999px;background:#FFF0EB;border:1px solid #FFDACB;color:#F83F70;padding:.28rem .62rem;font-size:.78rem;font-weight:700}.school-audit-empty{text-align:center;padding:2.5rem;color:#9E897D}.school-audit-table-wrap code{font-size:.76rem;color:#6B5548;background:#FAF5F0;border:1px solid #F0E6DD;padding:2px 6px;border-radius:4px}@media(max-width:1000px){.school-audit-kpis{grid-template-columns:repeat(2,1fr)}.school-audit-filter{grid-template-columns:1fr 1fr}}@media(max-width:640px){.school-audit-kpis,.school-audit-filter{grid-template-columns:1fr}}
</style>
HTML;
