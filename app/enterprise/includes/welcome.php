    ...
    <div class="ent-welcome__body">
        <div class="ent-welcome__content">
            ...
            <div class="ent-welcome__actions">
                <a href="../../talents.php" class="btn btn-primary" data-route="/app/enterprise/talents.php">
                    Xem nhân tài
                    <svg class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M5 12h14M12 5l7 7-7 7"/>
                    </svg>
                </a>
                <a href="../../internships" class="btn btn-secondary" data-route="/app/enterprise/internships">
                    Đăng tin tuyển dụng
                    <svg class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
