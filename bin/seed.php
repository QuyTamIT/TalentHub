...
try {
    $testing=in_array('--testing',$argv,true);$demo=in_array('--demo',$argv,true);$demoAi=in_array('--demo-ai',$argv,true);$schoolCredentials=in_array('--school-credentials',$argv,true);$enterprise=in_array('--enterprise',$argv,true);$env=Environment::appEnvironment();
