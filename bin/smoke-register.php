...
use TalentHub\Tests\Integration\StudentRegistrationIntegration;
...
try{
    ...
    $results=(new StudentRegistrationIntegration())->run($pdo,$config['database'],$runner,Environment::required('TALENTHUB_TEST_PASSWORD'));
