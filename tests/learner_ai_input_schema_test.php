...
ai_schema_assert($mysqlSql === $dcrSql, 'MySQL statements exactly reproduce approved DCR fence');
ai_schema_assert(hash('sha256', $mysqlSql) === 'af48c71c5d4dd825da3dfd8a2325662b9ae0dd1cd09123fa709a8296d5c0838a', 'MySQL statement fingerprint is approved');
