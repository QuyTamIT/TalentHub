...
final class DatabaseMigrationSmoke
{
    ...
    private function assertRolePermissionMatrix(PDO $pdo,RolePermissionSeeder $seeder): void
    {
        ...
        foreach($actual as &$permissions){sort($permissions);}unset($permissions);ksort($actual);
