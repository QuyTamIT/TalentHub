...
$profile = LearnerOpportunityProfile::fromInput(new RecommendationInput(
    ['education_band' => 'college', 'profile' => ['name' => 'Nguyễn Văn Bí Mật', 'email' => 'secret@example.test', 'phone' => '0900000000'], 'skills' => [
        ['code' => 'python', 'score' => 85, 'score_state' => 'scored'], ['code' => 'sql', 'score' => 45, 'score_state' => 'scored'],
    ]], [], [], [
...
$assert(JobMatchPromptRegistry::VERSION === 'learner-job-match-1.4.0', 'The strengths-based contract must use a new prompt version.');
...
$lowProfile = LearnerOpportunityProfile::fromInput(new RecommendationInput(
    ['education_band' => 'college', 'skills' => [['code' => 'python', 'score' => 5, 'score_state' => 'scored'], ['code' => 'sql', 'score' => 5, 'score_state' => 'scored']]], [], [], [
