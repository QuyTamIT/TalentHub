...
ai_assert($policy->inspectPaths(['bin/verify-demo-ai.php'])['allowed'], 'Task 9 demo verifier is allowed as an exact operational script');
ai_assert($policy->inspectPaths(['bin/worker-learner-ai-refresh.php'])['allowed'], 'Task 9 worker runner is allowed as an exact operational script');
ai_assert($policy->inspectPaths(['config/learner-ai-worker.php'])['allowed'], 'Task 9 worker configuration is allowed as an exact operational script');
ai_assert($policy->inspectPaths(['Database/seeds/Demo/CompleteAiDemoVerifier.php'])['allowed'], 'Task 9 demo verifier is allowed as an exact seed verifier');
ai_assert($policy->inspectPaths(['tests/complete_ai_demo_verifier_contract_test.php'])['allowed'], 'Task 9 verifier contract is allowed as an exact test');
ai_assert(!$policy->inspectPaths(['bin/verify-other-demo.php'])['allowed'], 'unreviewed bin siblings remain forbidden');
ai_assert(!$policy->inspectPaths(['Database/seeds/Demo/OtherSeeder.php'])['allowed'], 'unreviewed demo seed siblings remain forbidden');
