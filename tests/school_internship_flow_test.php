...
CREATE TABLE enterprises (id TEXT PRIMARY KEY, name TEXT NOT NULL, status TEXT NOT NULL, verificationStatus TEXT NOT NULL);
...
$pdo->prepare('INSERT INTO enterprises VALUES (?,?,?,?)')->execute([$enterprise, 'Enterprise', 'active', 'verified']);
