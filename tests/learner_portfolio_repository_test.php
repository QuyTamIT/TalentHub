...
SQL);
$pdo->exec('CREATE TABLE project_skill_tags(id VARCHAR(64) PRIMARY KEY,projectId VARCHAR(64),skillId VARCHAR(64),verifiedAt TEXT,createdAt TEXT)');
...
foreach ($evidenceMigration->migration->statements($driver) as $statement) { $pdo->exec($statement); }
...
$verified=$repo->review('ut1','project',$resub['id'],4,'verified','Good',['sk1','sk1'],['sk1'=>0]);
