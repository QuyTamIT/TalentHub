...
$schools=[];foreach($classes as $class){$schools[$class['schoolId']]=['id'=>$class['schoolId'],'name'=>$class['schoolName'],'schoolLevel'=>$class['schoolLevel']];}
?>
<!DOCTYPE html>
<html lang="vi">
<head>
