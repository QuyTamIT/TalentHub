        ...
        if ($pdo instanceof \PDO) {
            try {
                ...
                $targetEmails = match ($role) {
                    ...
                    \TalentHub\Rbac\RoleCodes::STUDENT => ['chau.thietke@talenthub.local', 'vo-duc-anh@student.btec.talenthub.local', 'student@talenthub.local', 'vuducanh@student.btec.edu.vn'],
