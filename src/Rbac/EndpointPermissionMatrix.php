...
final class EndpointPermissionMatrix
{
    ...
    public static function all(): array
    {
        return [
            ...
            'GET /api/v1/schools/me'=>'school_profile.read_own','PATCH /api/v1/schools/me'=>'school_profile.update_own','GET /api/v1/schools/me/dashboard'=>'school_dashboard.read_own','GET /api/v1/schools/me/analytics'=>'school_analytics.read_own','GET /api/v1/schools/me/ai-insights'=>'school_analytics.read_own',
            'GET /api/v1/schools/me/activities'=>'activity.review_school','PATCH /api/v1/schools/me/activities/{activityId}/review'=>'activity.review_school',
            'GET /api/v1/schools/me/credentials'=>'school_credential.manage_own','POST /api/v1/schools/me/credentials'=>'school_credential.manage_own',
            ...
            'GET /api/v1/students/me'=>'student_profile.read_own','PATCH /api/v1/students/me'=>'student_profile.update_own','POST /api/v1/students/me/avatar'=>'student_profile.update_own','GET /api/v1/students/me/dashboard'=>'student_dashboard.read_own',
            'GET /api/v1/businesses/me'=>'business_profile.read_own','PATCH /api/v1/businesses/me'=>'business_profile.update_own','POST /api/v1/businesses/me/logo'=>'business_profile.update_own','GET /api/v1/businesses/me/dashboard'=>'business_dashboard.read_own','GET /api/v1/businesses/me/analytics'=>'business_dashboard.read_own',
            ...
            'GET /api/v1/schools/me/internship-applications'=>'internship_application.read_own_school','POST /api/v1/schools/me/internship-applications/{applicationId}/mentor'=>'internship_mentor.assign_own_school',
            'GET /api/v1/schools/me/safeguarding-policy'=>'safeguarding.read_own_school','PATCH /api/v1/schools/me/safeguarding-policy'=>'safeguarding.update_own_school','GET /api/v1/schools/me/student-enterprise-approvals'=>'safeguarding.read_own_school','POST /api/v1/schools/me/student-enterprise-approvals'=>'safeguarding.approve_own_student','DELETE /api/v1/schools/me/student-enterprise-approvals/{approvalId}'=>'safeguarding.approve_own_student',
            'GET /api/v1/schools/me/profile-access-logs'=>'school_profile_access_log.read_own_school',
            'GET /api/v1/businesses/me/talents'=>'talent.search_consented','POST /api/v1/businesses/me/ai-matches'=>'talent.search_consented','GET /api/v1/businesses/me/talents/{studentId}'=>'talent.read_consented','POST /api/v1/businesses/me/talents/{studentId}/contact-requests'=>'contact_request.create_own_business',
