...
final class EndpointPermissionMatrix
{
    ...
    public static function all(): array
    {
        return [
            ...
            'GET /api/v1/schools/me/activity-visibility-policy'=>'activity.read_own_school',
            ...
            'GET /api/v1/schools/me/safeguarding-policy'=>'safeguarding.read_own_school','PATCH /api/v1/schools/me/safeguarding-policy'=>'safeguarding.manage_own_school','POST /api/v1/schools/me/guardian-consents'=>'safeguarding.manage_own_school','DELETE /api/v1/schools/me/guardian-consents/{decisionId}'=>'safeguarding.manage_own_school','POST /api/v1/schools/me/enterprise-approvals'=>'safeguarding.manage_own_school','DELETE /api/v1/schools/me/enterprise-approvals/{decisionId}'=>'safeguarding.manage_own_school',
