...
- `System/RolePermissionSeeder.php`: dữ liệu hệ thống bắt buộc, an toàn để chạy lặp; tạo 4 role, toàn bộ permission trong `document/RBAC_MATRIX.md` và mapping chính xác.
